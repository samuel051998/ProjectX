...
class MealsButton extends StatefulWidget {
  final String imagePath;
  final String text;

  const MealsButton(this.imagePath, this.text);

  @override
  _MealsButtonState createState() => _MealsButtonState(imagePath, text);
}

class _MealsButtonState extends State<MealsButton> {
  bool isPress = false;
  ...
  _MealsButtonState(this._imagePath, this._text);
