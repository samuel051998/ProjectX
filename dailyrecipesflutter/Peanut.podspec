...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Samuele" => "samuele.giacconeof@gmail.com" }
  # Or just: spec.author    = "Samuele"
  # spec.authors            = { "Samuele" => "samuele.giacconeof@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Samuele"
